...
public class SelectionControlLab {
    public static void main(String[] args) {
        ...
        // Step 4: Write a two-way if-else statement to compare equality and only print the following messages if the condition is met
        ...
        // Step 5: Write a multi-way if-else-if statement to compare num1 with 10 and only print the following messages if the condition is met
